...
public class RFUtilsTest {
	...
	public void testLoadDataFrame() {
		Frame frame = RFUtils.loadDataFrame(inputFilePath);
	...
	public void testCreateDRFParams() {
		...
		DRFParameters params = RFUtils.createDRFParams(args, frame);
	...
	public void testTrainModel() {
		...
		DRFModel model = RFUtils.trainModel(params, "my-model");
